...
namespace InventarioGEITests
{
    ...
    {
        public UsuariosController controller;
        ...
        public void Setup()
        {
            ...
            var usuarioToEdit = new Usuario { idUsuario = 5, email = "email", enabled = true, rolUsuario = rol };
            ...
            _dbContext.Usuario.Add(usuarioToEdit);
            _dbContext.SaveChangesAsync();
            controller = new UsuariosController(_dbContext);
        ...
        public async Task TestIndexView()
        {
            ...
            Assert.Greater(((IEnumerable<Usuario>)viewResult.Model).Count(), 0);
        }
        ...
        {
            var usuario = new Usuario { idUsuario = 2, email = "tipo" };
        ...
        {
            var usuario = new Usuario { idUsuario = 2 };
        ...
        {
            _dbContext.Entry(_dbContext.Usuario.Find(5)).State = EntityState.Detached;
            var usuarioEdited = new Usuario { idUsuario = 5, email = "tipo" };
            var result = await controller.Edit(5, usuarioEdited);
        ...
        public async Task TestEditIncorrect()
        {
            ...
            var result = await controller.Edit(5, usuario);
            var redirectResult = result as RedirectToActionResult;
